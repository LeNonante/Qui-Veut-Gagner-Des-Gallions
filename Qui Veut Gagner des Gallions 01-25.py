...
continuer = 1
while continuer==1:
    ##    #GESTION DE LAA LIGNE ANNIMEE AVEC LE TEMPS
    ##    x=int(str(datetime.now().time())[9:12])
    ##    if 0<=x<=161 and etat!=0:
    ##        Ligne = pygame.image.load("assets/Ligne1.png")
    ##        pos_ligne=Ligne.get_rect()
    ##        pos_ligne = pos_ligne.move(2000,2000)
    ##        pos_ligne=pos_ligne.move(-pos_ligne.x+206,-pos_ligne.y+120)
    ##    elif 161<=x<=322 and etat!=0:
    ##        Ligne = pygame.image.load("assets/Ligne2.png")
    ##        pos_ligne=Ligne.get_rect()
    ##        pos_ligne = pos_ligne.move(2000,2000)
    ##        pos_ligne=pos_ligne.move(-pos_ligne.x+206,-pos_ligne.y+120)
    ##    elif 322<=x<=483 and etat!=0:
    ##        Ligne = pygame.image.load("assets/Ligne3.png")
    ##        pos_ligne=Ligne.get_rect()
    ##        pos_ligne = pos_ligne.move(2000,2000)
    ##        pos_ligne=pos_ligne.move(-pos_ligne.x+206,-pos_ligne.y+120)
    ##    elif 483<=x<=644 and etat!=0:
    ##        Ligne = pygame.image.load("assets/Ligne4.png")
    ##        pos_ligne=Ligne.get_rect()
    ##        pos_ligne = pos_ligne.move(2000,2000)
    ##        pos_ligne=pos_ligne.move(-pos_ligne.x+206,-pos_ligne.y+120)
    ##    elif 644<=x<=805 and etat!=0:
    ##        Ligne = pygame.image.load("assets/Ligne5.png")
    ##        pos_ligne=Ligne.get_rect()
    ##        pos_ligne = pos_ligne.move(2000,2000)
    ##        pos_ligne=pos_ligne.move(-pos_ligne.x+206,-pos_ligne.y+120)
    ##    elif 805<=x<=999 and etat!=0:
    ##        Ligne = pygame.image.load("assets/Ligne6.png")
    ##        pos_ligne=Ligne.get_rect()
    ##        pos_ligne = pos_ligne.move(2000,2000)
    ##        pos_ligne=pos_ligne.move(-pos_ligne.x+206,-pos_ligne.y+120)

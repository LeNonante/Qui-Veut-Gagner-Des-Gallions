...
PointInterro = pygame.image.load("assets/PointInterro.png")
pos_point_interro=PointInterro.get_rect()
pos_point_interro = pos_point_interro.move(0,800)
pos_point_interro.centerx=170
        ...
        for event in pygame.event.get():   #On parcours la liste de tous les événements reçus
            ...
            if etat!=4 and etat!=5 and etat!=6: #Si pas perdu
                ...
                if event.type == MOUSEBUTTONDOWN:
                    ...
                    if 153<=event.pos[0]<=187 and 818<=event.pos[1]<=884:
                        webbrowser.open("https://forms.gle/HLtwjFYocji718Fp7")
                ...
                fenetre.blit(RondRouge, pos_rondrouge)
                fenetre.blit(RondVert, pos_rondvert)
                fenetre.blit(PointInterro, pos_point_interro)
